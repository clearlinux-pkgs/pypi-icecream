...
Source0  : https://files.pythonhosted.org/packages/78/5e/9f41831f032b9ce456c919c4989952562fcc2b0eb8c038080c24ce20d6cd/icecream-2.1.4.tar.gz
...
%prep
%setup -q -n icecream-2.1.4
cd %{_builddir}/icecream-2.1.4
pushd ..
cp -a icecream-2.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744393810
